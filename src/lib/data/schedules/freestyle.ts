	...
	schedule: {
		Samstag: [
			...
			},
			{
				...
				description:
					'Wir bringen euch die Basics des Freestyle Frisbee bei. Alle sind willkommen, egal ob ihr bereits eine Frisbeesportart spielt, oder noch nie eine Scheibe in der Hand hattet.',
				type: 'workshop',
